...
class DestroySheduleEmail extends Mailable  implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->markdown('emails.shedules.destroy_shedule', ['shedule_id' => $shedule_id])
            ->subject(  "SportFit: Отмена записи на тренировку" )
