    ...
    <div class="container"><p><br /></p>
        <div class="row">
            ...
            <div class="col-lg-5 ml-auto">
                ...
                <p>«{{ config('app.name') }}» — это команда профессионалов, индивидуальный подход к каждому посетителю клуба, самые современные технологии, опыт и знания лидеров фитнес- и велнес-индустрии.</p>
