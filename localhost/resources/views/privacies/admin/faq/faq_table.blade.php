            ...
            @foreach($question_from_contacts->get() as $question)
                ...
                <div class="row right">
                    ...
                    <div class="col-lg-8 mb-4 right">
                        <p>Вопорос #{{$question->contents_id}} пользователя от {{date_format(date_create($question->contents_updated_at), 'd-m-Y H:i')}}
                    ...
                    @if($question->contents_id === (int)$answer->question_id)
                        <div class="row left">
                            <div class="col-lg-8 mb-4 left">
                                <p>Ответ на вопрос #{{$answer->question_id}} от {{date_format(date_create($answer->contents_updated_at), 'd-m-Y H:i')}}</p>
